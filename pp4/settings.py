...
SECRET_KEY = 'django-insecure-wg)9ndc%3h6nak0!uzy%o^1y7jp2s3*ec=4+m8vtt!k7-2d1+0'
...
# # This ensures that Django also looks for static files inside your app's static folder
# STATICFILES_DIRS = [
#     os.path.join(BASE_DIR, 'static'),  # Change 'your_app' to your actual app name
# ]
